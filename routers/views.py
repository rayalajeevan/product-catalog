...
def updateCategory(category_id:int,category:BaseupdateCategory):
    try:
...
async def postProduct(product:BasePostProduct):
    try:
...
def updateProduct(product:BaseUpdateProduct,product_id:int):
    try:
